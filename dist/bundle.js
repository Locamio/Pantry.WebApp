...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storesTodoStoreJs = __webpack_require__(2);
	...
	var todoStore = new _storesTodoStoreJs2['default'](_dispatcherJs2['default']);
	_dispatcherJs2['default'].addStore(todoStore);
	_riot2['default'].mount('todo-app', { store: todoStore });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function TodoStore(dispatcher) {
	  ...
	  _riot2['default'].observable(this); // Riot provides our event emitter.
	  var self = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	_riot2['default'].tag('todo-item', '<span class="{done: opts.todo.done}" onclick="{toggle}">\n     {opts.todo.title}\n   </span>', function (opts) {
	  var dispatcher = this.opts.store.dispatcher;
